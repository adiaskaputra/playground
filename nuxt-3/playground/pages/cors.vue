...
<template>
  ...
  <button class="mr-2" @click="hitApi('fetch-alt-proxy')">Fetch - Alt Proxy</button>
  <button class="mr-2" @click="hitApi('fetch-manual-proxy')">Fetch - Manual Proxy</button>
  <button class="mr-2" @click="hitApi('fetch-api-route')">Fetch - API Route</button>
